...
* icon:cogs[] image:icons/fr.svg[width=20] Méthodologie de Production d'Application (MPA - M3301) (L2 level)
** icon:graduation-cap[]Contenu du module (link:{website}/topics/mpa.html[HTML], link:{website}/topics/mpa.dzslides.html[Slides]) => Cours 1 du 5/9/2016
** icon:cogs[] Conduite de projet, Tests, Agilité (et {scrum} en particulier) (link:{website}/topics/agile.html[HTML], link:{website}/topics/agile.dzslides.html[Slides]) => Cours 1 du 5/9/2016
** icon:cogs[] Cours sur l'approche Agile (et {scrum} en particulier) (link:{website}/topics/agile.html[HTML], link:{website}/topics/agile.dzslides.html[Slides]) => Cours 2 du 9/9/2016
** icon:cogs[] Cours sur {git} (link:{website}/topics/git.html[HTML], link:{website}/topics/git.dzslides.html[Slides]) => Cours 3 du 19/9/2016
** icon:cogs[] Cours sur l'intégration continue (link:{website}/topics/ci.html[HTML], link:{website}/topics/ci.dzslides.html[Slides]) => Cours 4 du 27/9/2016
...
* icon:graduation-cap[] link:http://jmbruel.github.io/MobileModeling/[Mobile Modeling] (L3 level)
...
- icon:cogs[] Advanced {sysML} at {uag}, Mexico
