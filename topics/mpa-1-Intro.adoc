...
| 2 | 12/09 | link:{base}/mpa-4-testingCI.html[Tests]
| 3 | 21/09 | link:{base}/mpa-3-manifesto.html[Manifeste Agile]
| 4 | 26/09 | link:{base}/git.html[Git]
| 5 | 01/10 | Behaviour-Driven Development
|===
