...
IMPORTANT: Les manipulations ci-dessous sont à faire dans un environnement
où vous avez un projet Java existant.

WARNING: Les scripts ou fichiers donnés ne marchent pas tel que. Il faut les adapter à votre environnement, et donc repérer ce qu'il y a à modifier!!
