...
[{topic}]
=== Exemple de CDCU (PTUT 2016)

link:CDCU-exemple.pdf[]

ifdef::slides[:leveloffset: +1]
// ------------------------------------------
[{intro}]
== icon:mail-bulk[] *Projet* MPA 2018

ifdef::slides[:leveloffset: -1]

[{topic}]
=== icon:exclamation-circle[] Problems
...
image::usage.jpg[width=90%,link="https://www.voxxed.com/2014/10/ides-vs-build-tools-how-eclipse-intellij-idea-netbeans-users-work-with-maven-ant-sbt-gradle/"]
...
image::bonnesPratiques.png[width=80%]
