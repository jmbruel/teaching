...
. icon:user-md[] Le Scrum Master créé un dépôt respectant la nomenclature : `MPA2017-G[1|2|3][A|B][1|2|3]`.
  Où le 1er numéro est le numéro du groupe de TD (entre 1 et 3),
