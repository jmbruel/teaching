...
je reçois souvent des mails comme celui-ci :

ifndef::slides[.Exemple de mail]
image::mail1.png[width=80%,link="{thisref}"]
ifdef::slides[NOTE: [detail]#Exemple de mail#]
...
. Etre capable d'importer et exporter ces informations sous un format {CSV}
.. Liste des entreprises
