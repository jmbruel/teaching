...
. icon:users[] Nominate a Scrum Master icon:user-md[] (at least for this practical work)
. icon:user-md[] Scrum Master create a repository with this naming protocol: `MPA2021-G1[1|2|3|4|5|6]`.
  Where you select your team number (don't choose yourself!)
