...
:numbered:
:status:
:siteurl: http://jmbhome.github.io/teaching/topics/testingCI.html
:bitlysiteurl: http://bit.ly/jmb-testingCI
//------------------------------------ Slides uniquement
ifdef::slides[]
//--------------------- dzslides slides
ifdef::dzslides[]
...
[{topic}]
==== Etape 1' : amériorer avec un `main`
...
| 2A2 | 1 | ~10 | image:buildNOK.png[width=30%]
